...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="sidbarUt.php">Accueil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../administrateur/gesMateriels/gestMateriels.html1.php">Liste des Matériels</a>
                </li>
                <li class="nav-item">
    ...
    <header class="bg-light py-4" style="">
        <div class="container text-center">
            <h1 class="display-4">Bienvenue dans le Système de Gestion de Stocks</h1>
            <p class="lead">Gérez vos matériels de manière simple et efficace.</p>
