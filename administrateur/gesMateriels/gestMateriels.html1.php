    ...
    <a href="navbar-brand"><img src="../../ressources/logo.jpg" width="140" height="45" alt="logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="http://localhost/gestion_de_stock/Utilisateurs/sidbarUt.php">Accueil</a>
                </li>
                <li class="nav-item">
                    <!-- <a class="nav-link active" aria-current="page" href="../gestUtilisateurs/gestionUtilisateur.html.php">Gestion des Utilisateurs</a> -->
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="#">Liste des Matériels</a>
                </li>
                <li class="nav-item">
